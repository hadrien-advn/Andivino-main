...
const DEF={wines:[
  {id:'clos-2017',nom:'Clos des Andes',millesime:2017,prix:19.99,reduction:0,bodega:'Bodega Poesía',appellation:'Luján de Cuyo, Mendoza',cepages:'100% Malbec — Vendanges manuelles',superficie:'2 ha plantés en 1935',sol:'Sablo-argileux',fermentation:'Inox et fûts de chêne',elevage:'10 à 12 mois',garde:'15 ans',dispo:true,description:"Le Clos des Andes dévoile un bouquet ample et expressif, marqué par des arômes de cerise noire mûre et de cassis, relevés d'une subtile note de chocolat noir."},
  ...
  list.innerHTML=wines.map(w=>{
    ...
    return `<div class="prod-item" id="pi-${w.id}">
      ...
      <div class="prod-right">
        <div class="prod-px">
          ${hr?`<span class="prod-px-old">${fmtPrix(w.prix)} €</span>`:''}
          <div class="prod-px-val">${fmtPrix(p)} €</div>
